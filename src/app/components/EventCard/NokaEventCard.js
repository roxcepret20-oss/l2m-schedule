...
import styles from "./NokaEventCard.module.css";
...
const BADGE_COLORS = [
  { bg: "rgba(5, 150, 105, 0.85)",  shadow: "rgba(5, 150, 105, 0.5)"  },
  { bg: "rgba(217, 119, 6, 0.85)",  shadow: "rgba(217, 119, 6, 0.5)"  },
  { bg: "rgba(37, 99, 235, 0.85)",  shadow: "rgba(37, 99, 235, 0.5)"  },
  { bg: "rgba(124, 58, 237, 0.85)", shadow: "rgba(124, 58, 237, 0.5)" },
];

export default function NokaEventCard({ event }) {
  ...
  return (
    ...
    >
      <div className={styles.noka_event_content}>
        ...
        <div className={styles.noka_event_name}>{event.name}</div>
        <div className={styles.noka_event_detail}>Time: {event.spawn_time ?? "—"}</div>
        <div className={styles.noka_event_timer}>
          <svg
        ...
        <div className={styles.noka_event_meta}>
          <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
        ...
        {pts && (
          <div className={styles.noka_points_badges}>
            {pts.map((p, i) => (
              <span
                key={i}
                className={styles.noka_points_badge}
                style={{
